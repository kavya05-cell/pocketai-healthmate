        ...
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex items-center space-x-2 md:space-x-3">
            ...
            <div className="md:hidden">
              <h1 className="text-xs xs:text-sm font-bold text-foreground">
                HealthMate
              </h1>
            </div>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-2">
            {/* Auth Links */}
            <Link to="/login">
              <Button variant="outline" size="md" className="text-sm px-4">
                Sign In
              </Button>
            </Link>
            <Link to="/signup">
              <Button size="md" className="text-sm px-4">
                Sign Up
              </Button>
            </Link>
            ...
            <Sheet open={isMenuOpen} onOpenChange={setIsMenuOpen}>
              <SheetTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-8 w-8 xs:h-9 xs:w-9 transition-colors"
                >
                  {isMenuOpen ? (
              ...
              <SheetContent side="right" className="w-[280px] md:w-[350px]">
